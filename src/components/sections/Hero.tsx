...
const skills = ["Java", "Spring Boot", "React.js", "SQL"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Java Full Stack Developer", "Final-year Engineering Student", "Happy coding!"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Building production-style web applications with Java, Spring
            Boot, and SQL on the backend, and React on the frontend. Focused
            on writing clean, efficient code and turning ideas into working
            software.
          </p>
        </motion.div>
