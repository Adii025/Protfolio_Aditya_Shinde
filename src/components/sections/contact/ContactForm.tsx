...
const socialLinks = [
  {
    title: 'Email',
    user: 'shindeadityawork@gmail.com',
    icon: FaEnvelope,
    link: 'mailto:shindeadityawork@gmail.com',
  },
  {
    title: 'Github',
    user: '@Adii025',
    icon: FaGithub,
    link: 'https://github.com/Adii025',
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        <motion.a
          href="https://www.linkedin.com/in/aditya-shinde-5801aa2ab/"  
          target="_blank"
